...
//        if (strExecutionType.equalsIgnoreCase("BROWSER")) {
        ...
        System.out.println("Inside DriverUtil - Inside getDriver - strBrowser " + strBrowser);

        String strExecutionType = System.getProperty(Constants.ENV_VARIABLE_EXECUTION_TYPE, "");

        System.out.println("getDriver ExecutionType " + strExecutionType);

        if (strConfig.isEmpty() || strExecutionType.equalsIgnoreCase("WEBMOBILE")) {
            //for (String browser : browsers) {

            //System.out.println("Inside WEBMOBILE if for");
...
//    The getMobileDriver method used to
    ...
    private static WebDriver getLocalDriver(String strBrowserName) {
        ...
        System.out.println("getLocalDriver ExecutionView " + strExecutionView);

        try {
            final String osName = OSValidator.getOSName();
            System.out.println("getLocalDriver osName " + osName);
            ...
            switch (strBrowserName) {
                ...
                case "chrome":
                    if (osName.toUpperCase().equals(Constants.MAC)) {
                        ...
                        System.out.println("Inside getLocalDriver - case chrome " + Constants.CHROME_DRIVER_PATH);
                    ...
                    if ("mobileview".equalsIgnoreCase(strExecutionView)) {
                        ...
                        System.out.println("Inside getLocalDriver - case chrome else chromecapabilities");
                ...
                default:
                    System.out.println("Inside getLocalDriver - Switch case Default ");
                    if (osName.toUpperCase().equals(Constants.MAC)) {
                        System.setProperty("webdriver.chrome.driver", Constants.CHROME_DRIVER_MAC_PATH);
                    } else {
                        System.setProperty("webdriver.chrome.driver", Constants.CHROME_DRIVER_PATH);
...
//        safariOptions.useCleanSession(true);
    ...
    public static ChromeOptions chromeCapabilities() {
        ...
        System.out.println("Inside DriverUtil ChromeOptions chromeCapabilities");
        ...
        //options.addArguments("--enable-features=FedCM");
        ...
        //Adding chromePrefs instead of DesiredCapabilities - by Bhaanu on 02 March 2025
        chromePrefs.put("platformName", "Android");
        chromePrefs.put("deviceName", "Galaxy M53");
        chromePrefs.put("browserName", "Chrome");
        chromePrefs.put("real_mobile", "true");
        chromePrefs.put("autoGrantPermissions", "true");
        chromePrefs.put("disable-popup-blocking", "true");
        chromePrefs.put("autoDismissAlerts", "true");
        chromePrefs.put("unicodeKeyboard", "true");
        chromePrefs.put("resetKeyboard", "true");


        /* Commented by Bhaanu on 02 March 2025
